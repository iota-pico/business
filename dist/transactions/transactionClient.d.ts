...
export declare class TransactionClient implements ITransactionClient {
     ...
     */
    constructor(apiClient: IApiClient, timeProvider?: ITimeProvider);
    /**
    ...
    private signInputsAndReturn(seed, bundle, signatureFragments, inputs, security, addedHMAC, hmacKey);
}
